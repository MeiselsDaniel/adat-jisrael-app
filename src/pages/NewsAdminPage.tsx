    ...
    <div className="space-y-5">
      ...
      {formOpen && (
        ...
        >
          ...
          <section className="space-y-4 rounded-2xl bg-sky-50 p-4 ring-1 ring-sky-100">
            <div>
              <p className="font-bold text-[#183b70]">
                Extern länk
              </p>
              ...
              <p className="mt-1 text-xs leading-5 text-slate-500">
                Valfritt. Lägg till en knapp i nyheten som länkar till exempelvis en anmälan eller extern eventsida.
              </p>
            </div>
            ...
            <label className="block">
              ...
              <input
                ...
                placeholder="https://..."
                className="mt-2 w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm outline-none focus:border-sky-600"
              />
            </label>
            ...
            {linkUrl.trim() && (
              <label className="block">
                ...
                <p className="mt-1 text-xs text-slate-500">
                  Exempel: Läs mer, Anmäl dig eller Till eventet
                </p>
              </label>
            )}
          </section>
